...
import { WalletIcon, BanknotesIcon, ChartBarIcon, ScaleIcon } from "@heroicons/react/24/outline";
...
export default function DashboardPage() {
  ...
  const metrics = {
    ...
    totalEarned: investments.reduce((sum, inv) => sum + (inv.currentCapital - inv.initialCapital), 0),
        ...
        <Card className="bg-gray-900 text-white">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold">${metrics.currentAmount.toLocaleString()}</p>
            </div>
          </div>
        </Card>
